    ...
    <main style={pageStyle}>
      <section style={heroStyle}>
        ...
        <p style={introStyle}>
          ...
          Voice Transcript, Google Workspace bidirectional sync (Sheets, Drive, Gmail, Apps Script), Gemini key config, Korean law, SEO, local agent AI, FinanceHub, internal knowledge, browser recording, SSL,
